...
const SettingItem: React.FC<SettingItemProps> = ({ label, value, onPress, showArrow = true }) => (
...
const styles = StyleSheet.create({
    ...
    settingsSection: { backgroundColor: '#FFFFFF', marginHorizontal: 16, borderRadius: 12, overflow: 'hidden' },
    ...
    switchItem: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingVertical: 14 },
    completeButton: { backgroundColor: '#F5D76E', borderRadius: 30, paddingVertical: 15, alignItems: 'center', justifyContent: 'center', marginTop: 'auto', marginBottom: 32, marginHorizontal: 32 },
    completeButtonText: { fontSize: 17, fontWeight: '600', color: '#333' },
    modalOverlay: {
        flex: 1,
