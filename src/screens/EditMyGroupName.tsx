...
const EditMyGroupNameScreen: React.FC = () => {
  ...
  const handleConfirm = () => {
    ...
    console.log("My Group Name updated:", name);
    handleGoBack();
  };
    ...
    <LinearGradient colors={colors.background.gradientYellow} style={styles.container}>
      <SafeAreaView style={{ flex: 1 }} edges={["top"]}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>我在群里的名称</Text>
...
export default EditMyGroupNameScreen;
