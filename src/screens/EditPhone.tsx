...
const styles = StyleSheet.create({
    ...
    inputContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFFFFF', borderRadius: 30, paddingHorizontal: 20, height: 52, marginBottom: 20 },
    input: { flex: 1, fontSize: 15, color: '#333' },
    clearButton: { padding: 4, marginLeft: 8 },
    actionButton: { backgroundColor: '#F5D76E', borderRadius: 30, paddingVertical: 15, alignItems: 'center', justifyContent: 'center', marginBottom: 16 },
