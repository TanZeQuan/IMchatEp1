  ...
  <TouchableOpacity style={styles.item} onPress={onPress}>
    ...
    <View style={styles.valueContainer}>
      {label === '头像' ? (
        ...
        <Ionicons name="qr-code-outline" size={24} color="#666" style={styles.qrIcon} />
      ) : (
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingVertical: 12, backgroundColor: '#F5D76E' },
  backButton: { width: 40 },
  headerTitle: { fontSize: 16, fontWeight: '500', color: '#333' },
  placeholder: { width: 40 },
  content: { backgroundColor: '#fff' },
  item: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: '#F0F0F0' },
  label: { fontSize: 15, color: '#333' },
  valueContainer: { flexDirection: 'row', alignItems: 'center' },
  value: { fontSize: 15, color: '#999', marginRight: 8 },
  avatar: { width: 40, height: 40, borderRadius: 4, overflow: 'hidden', marginRight: 8, backgroundColor: '#EEE' },
